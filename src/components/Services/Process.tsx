        ...
        <div ref={ref} className="w-full my-6 z-10 flex flex-col items-center justify-center mt-16 sm:mt-32">
            ...
            <div className="w-[90%] grid grid-cols-4 gap-4">
                <div className="col-span-4">
                    ...
                    <Grow in={currentIndex >= 2} timeout={300}>
                        <h2 className="font-body text-[#4e5e9d] text-lg sm:text-2xl rounded-xl drop-shadow-md text-center">
            ...
            <div className="w-[80%] grid grid-cols-6">
                ...
                <div className="mt-2 sm:ml-4 col-span-6 md:col-span-4 flex flex-col justify-center space-y-4 row-span-2">
                    <Grow in={currentIndex >= 6} timeout={300}>
                        <div className="flex items-left text-3xl sm:text-3xl text-[#7087ff] drop-shadow-sm text-left mb-2 mt-8">
            ...
            <div className="w-[80%] grid grid-cols-6">
                ...
                <div className="mt-2 sm:ml-4 col-span-6 md:col-span-4 flex flex-col justify-center space-y-4 row-span-2">
                    <Grow in={currentIndex >= 8} timeout={300}>
                        <div className="flex items-left text-3xl sm:text-3xl text-[#7087ff] drop-shadow-sm text-left mb-2 mt-8 ml-0 md:ml-32">
                    ...
                    <Grow in={currentIndex >= 9} timeout={300}>
                        <div>
                            <h2 className="font-body text-[#4e5e9d] text-lg sm:text-2xl rounded-xl drop-shadow-md text-justify ml-0 md:ml-32">
            ...
            <div className="w-[80%] grid grid-cols-6">
                ...
                <div className="mt-2 sm:ml-4 col-span-6 md:col-span-4 flex flex-col justify-center space-y-4 row-span-2">
                    <Grow in={currentIndex >= 10} timeout={300}>
                        <div className="flex items-left text-3xl sm:text-3xl text-[#7087ff] drop-shadow-sm text-left mb-2 mt-8 ml-0 md:ml-64">
                    ...
                    <Grow in={currentIndex >= 11} timeout={300}>
                        <div>
                            <h2 className="font-body text-[#4e5e9d] text-lg sm:text-2xl rounded-xl drop-shadow-md text-justify ml-0 md:ml-64">
