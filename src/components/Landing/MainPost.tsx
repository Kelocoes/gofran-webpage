    ...
    return (
        <div ref={ref} className="w-[95%] my-6 z-10">
            ...
            <Zoom in={currentIndex >= 1} timeout={300}>
                <h1 className="font-title text-4xl sm:text-8xl text-[#6543AD] drop-shadow-lg text-left mb-2">
                    Revoluciona <strong className="underline">tu mente</strong>: descubre el poder 
                    <div className="flex items-center">
                        de la Psicología <img src={horizontalDiamond} alt="Horizontal Diamond" className="w-1/12 ml-1" />
                    </div>
                </h1>
            </Zoom>
            ...
            <div className="sm:w-[80%] gap-2 items-center">
                <div className="flex flex-col justify-center space-y-6 ">
                    <Zoom in={currentIndex >= 3} timeout={300}>
                        <h2 className="font-body text-[#6543AD] text-lg sm:text-4xl rounded-xl drop-shadow-md w-[90%]">
                    ...
                    <Zoom in={currentIndex >= 5} timeout={300}>
                        <div className="flex justify-center">
                            <div className="flex flex-col sm:px-20 sm:w-[60%]">
                                <div className="flex justify-center sm:justify-start my-2">
                                    <h2 className="font-body text-[#6543AD] text-2xl py-5 px-6 text-center border-4 rounded-3xl bg-[#FED8B1] border-[#FABC7B] w-max">
                                        Terapia 100% online
                                    </h2>
                                </div>
                                <div className="flex justify-center sm:justify-end my-2">
                                    <h2 className="font-body text-[#6543AD] text-2xl py-5 px-6 text-center border-4 rounded-3xl border-[#6543AD] w-max">
