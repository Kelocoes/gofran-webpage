            ...
            <div className="relative">
                ...
                <div className="grid grid-cols-5 gap-4 items-center">
                    <Zoom in={currentIndex >= 3} timeout={300}>
                        <h2 className="font-body text-white text-lg sm:text-2xl text-center sm:text-justify mt-8 drop-shadow-md col-span-5 font-bold">
                    ...
                    <Zoom in={currentIndex >= 5} timeout={300}>
                        <div className="flex ml-auto my-2 border-[#B6C2FD] border-8 rounded-[60px] p-5 col-span-3">
                            <h2 className="font-body text-white text-lg sm:text-2xl text-center md:text-justify drop-shadow-md font-bold">
