...
export default function LetsTalk(): JSX.Element {
    ...
    return (
        <div ref={ref} className="w-full bg-[#ffeedd] my-0 z-10 flex flex-col items-center justify-center relative mt-0 sm:mt-0">
            ...
            <div className="w-full max-w-7xl grid grid-cols-6 gap-4">
                ...
                <div className="mt-2 sm:ml-4 col-span-6 md:col-span-4 flex flex-col justify-center space-y-4 row-span-2 w-[90%] ml-4">
                    ...
                    <Grow in={currentIndex >= 7} timeout={300}>
                        <div className="flex items-center">
                            ...
                            <h2 className="font-body text-[#4e5e9d] text-md sm:text-2xl ml-2">
