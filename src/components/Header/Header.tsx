        ...
        <div className="flex items-center justify-center pt-2 z-10 mx-10">
            {matches ?
                <ul className="menu menu-vertical sm:menu-horizontal rounded-box bg-white text-black lg:w-max items-center shadow-lg py-1">
                    ...
                    <li><a className="font-body font-semibold text-lg" onClick={() => choose(0)}>Inicio</a></li>
                    <li><a className="font-body font-semibold text-lg" onClick={() => choose(1)}>Sobre mi</a></li>
                    <li><a className="font-body font-semibold text-lg truncate" onClick={() => choose(2)}>Tratamientos / Servicios</a></li>
                    <li><a className="font-body font-semibold text-lg" onClick={() => choose(3)}>Contáctame</a></li>
                </ul>
                :
