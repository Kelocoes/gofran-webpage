            ...
            <Zoom in={true} timeout={500}>
                {matches ?
                    <ul className="menu menu-vertical sm:menu-horizontal rounded-box bg-white text-slate-600 lg:w-max items-center shadow-lg py-1">
                        ...
                        <li><a className="font-body font-semibold text-lg" onClick={() => choose(0)} role="button">Inicio</a></li>
                        <li><a className="font-body font-semibold text-lg" onClick={() => choose(1)} role="button">Sobre mi</a></li>
                        <li><a className="font-body font-semibold text-lg truncate" onClick={() => choose(2)} role="button">Tratamientos / Servicios</a></li>
                        <li><a className="font-body font-semibold text-lg" onClick={() => choose(3)} role="button">Contáctame</a></li>
                    </ul>
                    :
