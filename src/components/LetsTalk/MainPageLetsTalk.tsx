    ...
    return (
        <div ref={ref} className="w-[85%] my-6 z-10 flex flex-col items-center justify-center relative mt-0 sm:mt-8">
            ...
            <div className="w-[90%] grid grid-cols-6 gap-4">
                ...
                <div className="col-span-6 md:col-span-2 flex flex-col items-center justify-center hidden md:block md:-ml-8">
                ...
                <div className="md:mt-16 sm:ml-4 col-span-6 md:col-span-6 flex flex-col justify-center space-y-2 row-span-2">
                    ...
                    <Grow in={currentIndex >= 3} timeout={300}>
                        <h2 className="flex font-body text-[#4e5e9d] text-lg sm:text-lg rounded-xl drop-shadow-md text-justify pt-4">
